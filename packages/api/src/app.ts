...
import personInvoices from "./controllers/person_invoices.js";
import legacyInvoices from "./controllers/legacy_invoices.js";
import refunds from "./controllers/refunds.js";
...
app.use("/", payments);
app.use("/", invoices);
app.use("/", personInvoices);
app.use("/", legacyInvoices);
app.use("/", refunds);
app.use("/", songs);
app.use("/", accounts);
app.use("/", genres);
