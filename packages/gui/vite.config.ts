...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      "/service-groups": { target: "http://localhost:3000", bypass: bypassHtmlRequests },
      ...
      "/gig-payments": { target: "http://localhost:3000", bypass: bypassHtmlRequests },
      "/refunds": { target: "http://localhost:3000", bypass: bypassHtmlRequests },
       ...
       "/person-invoices": { target: "http://localhost:3000", bypass: bypassHtmlRequests },
      ...
      "/accounts": { target: "http://localhost:3000", bypass: bypassHtmlRequests },
       "/accounting": { target: "http://localhost:3000", bypass: bypassHtmlRequests },
       "/vat": { target: "http://localhost:3000", bypass: bypassHtmlRequests },
       "/dashboard": { target: "http://localhost:3000", bypass: bypassHtmlRequests },
