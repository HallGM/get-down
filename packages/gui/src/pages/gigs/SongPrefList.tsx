...
export default function SongPrefList({ label, ids, songs, onChange }: Props) {
  ...
  return (
    <details style={{ marginBottom: "0.75rem" }}>
      ...
      <div style={{ marginTop: "0.5rem" }}>
        {selected.map(s => (
          <div key={s.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0.2rem 0.4rem", marginBottom: "0.15rem", background: "var(--pico-card-background-color)", border: "1px solid var(--pico-muted-border-color)", borderRadius: "var(--pico-border-radius)" }}>
            <span>
              {s.title}
